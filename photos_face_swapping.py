...
for face in faces:
    ...
    for n in range(0, 68):
        ...
        # draw facial landmarks we've detected using the predictor (non functional, helpful to visualize)
    ...
    # draw convex hull on original image (non functional, helpful to visualize)
...
# Resize image
resize = ResizeWithAspectRatio(seamlessclone, width=800)            
cv2.imshow("seamlessclone", resize)
cv2.waitKey(0)
